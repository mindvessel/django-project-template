...
See also https://docs.djangoproject.com/en/6.1/howto/deployment/checklist/
...
MIDDLEWARE = [
    # https://docs.djangoproject.com/en/6.1/ref/middleware/#django.middleware.security.SecurityMiddleware
    ...
    # https://docs.djangoproject.com/en/6.1/ref/clickjacking/
...
# https://docs.djangoproject.com/en/6.1/ref/databases/#sqlite-notes
