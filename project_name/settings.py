...
See also https://docs.djangoproject.com/en/6.0/howto/deployment/checklist/
...
MIDDLEWARE = [
    # https://docs.djangoproject.com/en/6.0/ref/middleware/#django.middleware.security.SecurityMiddleware
...
# https://docs.djangoproject.com/en/6.0/ref/databases/#sqlite-notes
